...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QRect(10, 10, 381, 401))
        ...
        self.login_button = QToolButton(self.layoutWidget)
        self.login_button.setObjectName(u"login_button")
        self.login_button.setFont(font)
        self.login_button.setContextMenuPolicy(Qt.DefaultContextMenu)
        self.login_button.setPopupMode(QToolButton.DelayedPopup)
        self.login_button.setToolButtonStyle(Qt.ToolButtonIconOnly)

        self.horizontalLayout_10.addWidget(self.login_button)
        ...
        self.horizontalLayout_13.addWidget(self.RC_Groups_List)

        self.verticalLayout_6 = QVBoxLayout()
        self.verticalLayout_6.setObjectName(u"verticalLayout_6")
        self.RC_Add_Button = QPushButton(self.layoutWidget)
        self.RC_Add_Button.setObjectName(u"RC_Add_Button")
        sizePolicy.setHeightForWidth(self.RC_Add_Button.sizePolicy().hasHeightForWidth())
        self.RC_Add_Button.setSizePolicy(sizePolicy)
        self.RC_Add_Button.setMaximumSize(QSize(25, 16777215))

        self.verticalLayout_6.addWidget(self.RC_Add_Button)

        self.RC_Delete_Button = QPushButton(self.layoutWidget)
        self.RC_Delete_Button.setObjectName(u"RC_Delete_Button")
        self.RC_Delete_Button.setMaximumSize(QSize(25, 16777215))

        self.verticalLayout_6.addWidget(self.RC_Delete_Button)


        self.horizontalLayout_13.addLayout(self.verticalLayout_6)

        self.RC_Groups_List_2 = QListWidget(self.layoutWidget)
        self.RC_Groups_List_2.setObjectName(u"RC_Groups_List_2")

        self.horizontalLayout_13.addWidget(self.RC_Groups_List_2)
        ...
        self.layoutWidget1.setGeometry(QRect(431, 12, 231, 401))
        ...
        self.RD_Domain_ComboBox = QComboBox(self.layoutWidget1)
        ...
        self.RD_Login_Line = QLineEdit(self.layoutWidget1)
        ...
        self.RD_Password_Line = QLineEdit(self.layoutWidget1)
        ...
        self.EM_Line = QLineEdit(self.layoutWidget1)
        ...
        self.EM_Pass_Line = QLineEdit(self.layoutWidget1)
        ...
        self.SIP_Line = QLineEdit(self.layoutWidget1)
        ...
        self.SIP_Pass_Line = QLineEdit(self.layoutWidget1)
